...
from utils import *
img_path='C:\\Users\\19051\\Desktop\\raw'
out_path='C:\\Users\\19051\\Desktop\\cropped'
...
parser.add_argument('--image', type=str, default=names,
...
def _main():
    ...
    if args.image:
        ...
        for i in range(len(args.image)):
            imgs+=[cv2.imread(os.path.join(img_path,names[i]))]
        cap=0
    elif args.video:
    ...
    while True:
        ...
        faces = post_process(frame, outs, CONF_THRESHOLD, NMS_THRESHOLD,os.path.join(out_path,names[i][:-4]))
